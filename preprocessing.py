...
apply ZCA whitening and save (optional)

requires the following arguments:
- path to X_train.txt file, e.g, "./data/X_small_train.txt"
- path to X_test.txt file, e.g., "./data/X_small_test.txt"
- 1 to enable ZCA whitening (optional, requires scipy and theano)
